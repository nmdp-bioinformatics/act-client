...
class TypeSeqApi(object):
    ...
    def typeseq_get(self, sequence, **kwargs):  # noqa: E501
        ...
        >>> thread = api.typeseq_get(locus, sequence, async=True)
        >>> result = thread.get()
    ...
    def typeseq_get_with_http_info(self, sequence, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.typeseq_get_with_http_info(locus, sequence, async=True)
        >>> result = thread.get()
        ...
        if ('sequence' not in params or
            ...
            raise ValueError("Missing the required parameter `sequence` when calling `typeseq_get`")  # noqa: E501
